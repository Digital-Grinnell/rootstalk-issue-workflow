...
This portion of the workflow MUST follow successful publication of an issue in-print.
  ...
  - Inside the `-web-resources` folder, create an `issue.yml` file reflecting the web-structure of the _issue_.  See the [Issue.YML File](./Issue.YML File) section for details.  In our `2022-spring` example the file should have a path of: `./2022-spring/2022-spring-web-resources/issue.yml`.
